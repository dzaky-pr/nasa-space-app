...
const features = [
  {
    ...
    background: (
      <div className="absolute h-full w-full [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] ">
        <video src="https://res.cloudinary.com/dzaky/video/upload/v1728139295/wawancara_e3xyoa.mp4" autoPlay loop muted playsInline className="pointer-events-none h-full w-full object-cover  group-hover:scale-105" />
      </div>
    ),
  },
  {
    ...
    background: (
      <div className="absolute h-full w-full [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] ">
        <video src="https://res.cloudinary.com/dzaky/video/upload/v1728151015/foto-bareng-cut_pubfyw.mp4" autoPlay loop muted playsInline className="pointer-events-none h-full w-full object-cover  group-hover:scale-105" />
      </div>
    ),
  },
  {
    ...
    background: (
      <div className="absolute h-full w-full [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] ">
        <video src="https://res.cloudinary.com/dzaky/video/upload/v1728139290/demo-pakai_vgkqjg.mp4" autoPlay loop muted playsInline className="pointer-events-none h-full w-full object-cover  group-hover:scale-105" />
      </div>
    ),
  },
  {
    ...
    background: (
      <div className="absolute h-full w-full [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] ">
        <video src="https://res.cloudinary.com/dzaky/video/upload/v1728139290/fira-and-neutrack_ndwmp0.mp4" autoPlay loop muted playsInline className="pointer-events-none h-full w-full object-cover  group-hover:scale-105" />
      </div>
    ),
  },
];
