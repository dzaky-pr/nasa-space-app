    ...
    <div className={cn("relative", className)}>
      ...
      >
        <img
          ...
          width={1920}
          height={1080}
          className="w-full transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-md shadow-lg border-[0.5px] border-gray-700"
        />
        ...
        {isVideoOpen && (
          ...
          >
            ...
            >
              ...
              <div className="size-full border-[0.5px] border-gray-700 rounded-2xl overflow-hidden isolate z-[1] relative">
                <iframe
                  src={videoSrc}
