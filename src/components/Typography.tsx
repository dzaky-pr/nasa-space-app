...
export default function Typography<T extends React.ElementType>({ as, children, weight = 'regular', className, font = 'Inter', variant = 'p', ...props }: TypographyProps<T> & Omit<React.ComponentProps<T>, keyof TypographyProps<T>>) {
  ...
  return (
    <Component
      className={clsxm(
        // *=============== Font Type ==================
        'text-white',
        [font === 'Inter' && ['font-inter', [weight === 'regular' && 'font-normal', weight === 'medium' && 'font-medium', weight === 'bold' && 'font-bold']]],
        // *=============== Font Variants ==================
        [
